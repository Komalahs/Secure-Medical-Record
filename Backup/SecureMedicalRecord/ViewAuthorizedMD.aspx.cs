...
{
    public partial class ViewAuthorizedMD : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                tab = objSecureMedicalRecordBLL.GetMedicalRecordA_ViewData(objSecureMedicalRecordDTO);
                if (tab.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < tab.Rows.Count; i++)
                    {
                        ...
                        lnk.Text = "View";
                        lnk.CommandArgument = tab.Rows[i]["AccessKey"] + "-" + tab.Rows[i]["RecordData"] + "-" + tab.Rows[i]["DataKey"];
