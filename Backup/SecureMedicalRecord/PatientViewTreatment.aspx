<%@ Page Title="" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="PatientViewTreatment.aspx.cs" Inherits="SecureMedicalRecord.PatientViewTreatment" %>
                            ...
                            <div class="col-lg-12">
                               <%-- <form id="Form1" role="form" runat="server">--%>
                                <div class="form-group">
                                    <label>
                                        Patient Id</label>
                                    <asp:TextBox ID="txtPatientId" class="form-control" runat="server" placeholder="Enter Patient Id" ReadOnly="true"></asp:TextBox>
